export const MAP = { width: 1600, height: 1000 } as const;
...
export const ROOMS: Room[] = [
  { x: 42, y: 42, w: 350, h: 255, name: 'PHÒNG ĐIỆN', kind: 'station', door: 'right' },
  { x: 625, y: 42, w: 350, h: 225, name: 'Y TẾ', kind: 'station', door: 'bottom' },
  { x: 1208, y: 42, w: 350, h: 255, name: 'DỮ LIỆU', kind: 'station', door: 'left' },
  { x: 560, y: 340, w: 480, h: 320, name: 'PHÒNG HỌP', kind: 'meeting', door: 'cross' },
  { x: 42, y: 703, w: 350, h: 255, name: 'KHO NHIÊN LIỆU', kind: 'station', door: 'right' },
  { x: 625, y: 733, w: 350, h: 225, name: 'ĐỘNG CƠ', kind: 'station', door: 'top' },
  { x: 1208, y: 703, w: 350, h: 255, name: 'ĐIỀU KHIỂN', kind: 'station', door: 'left' }
];
...
export const DOORS: Rect[] = [
  { x: 560, y: 442, w: 18, h: 116 }, { x: 1022, y: 442, w: 18, h: 116 },
  { x: 742, y: 340, w: 116, h: 18 }, { x: 742, y: 642, w: 116, h: 18 }
];
export const STATIONS = [
  { id: 'wires', name: 'Nối mạch điện', room: 'PHÒNG ĐIỆN', x: 192, y: 160, icon: '⚡' },
  { id: 'fuel', name: 'Nạp nhiên liệu', room: 'KHO NHIÊN LIỆU', x: 192, y: 830, icon: '◈' },
  { id: 'scan', name: 'Quét sinh học', room: 'Y TẾ', x: 800, y: 147, icon: '✚' },
  { id: 'upload', name: 'Tải dữ liệu', room: 'DỮ LIỆU', x: 1398, y: 160, icon: '▣' },
  { id: 'calibrate', name: 'Hiệu chỉnh lái', room: 'ĐIỀU KHIỂN', x: 1398, y: 830, icon: '◎' }
] as const;
export const VENTS = [
  { x: 318, y: 230, to: 1 }, { x: 800, y: 838, to: 0 },
  { x: 1282, y: 230, to: 3 }, { x: 800, y: 500, to: 2 }
] as const;
export const REACTOR_FIXES = [{ x: 205, y: 500 }, { x: 1395, y: 500 }] as const;
export const EMERGENCY = { x: 800, y: 500 } as const;
